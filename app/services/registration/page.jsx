      ...
      <main className="container mx-auto max-w-5xl px-4 py-10 space-y-10">
        <header className="space-y-2">
          ...
          <p className="text-base" style={{ color: 'var(--secondary-label)' }}>
            Select a structure, share your budget, and Documotion will generate timelines, collect
            documents, and track payments. The flow below uses a sandbox startup profile so you can
            test the experience.
          </p>
        </header>
