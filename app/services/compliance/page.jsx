...
export const metadata = {
  ...
  description: "Automate annual compliance, certifications, and ongoing filings with Documotion specialists.",
};
      ...
      <main className="container mx-auto max-w-6xl px-4 py-10 space-y-10">
        <header className="space-y-2">
          ...
          <p className="text-base" style={{ color: "var(--secondary-label)" }}>
            Stay ahead of filings and certifications with Documotion’s managed services. Engage our specialists
            for ISO, GST, ROC, payroll, and post-incorporation compliance. Each listing below includes turnaround
            times, document checklists, and transparent pricing.
          </p>
        </header>
        ...
        {servicesByCategory.map(([category, items]) => (
          <section key={category} className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {items.map(service => (
                <article key={service.id} className="glass rounded-2xl p-6 border border-white/10 space-y-3">
                  <div className="flex items-center justify-between">
                  ...
                  <div className="space-y-2">
                    <div className="text-xs font-semibold" style={{ color: "var(--secondary-label)" }}>
                      Requirements
                    </div>
                  ...
                  {service.deadline && (
                    <div className="rounded-lg px-3 py-2 text-xs" style={{ backgroundColor: "rgba(255, 193, 7, 0.1)", color: "var(--system-yellow)" }}>
