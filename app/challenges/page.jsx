      ...
      <main className="container mx-auto max-w-6xl px-4 py-10 space-y-8">
        <header className="space-y-2">
          ...
          <p className="text-base" style={{ color: 'var(--secondary-label)' }}>
            Track the latest government and ecosystem opportunities—awards, grants, accelerators,
            and national challenges. Documotion highlights deadlines, benefits, and organisers so
            you can prioritise the right programmes for your startup.
          </p>
        </header>
