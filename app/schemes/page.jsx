...
export const metadata = {
  ...
  description:
    'Browse curated government programmes with eligibility, benefits, and official links.',
};
      ...
      <main className="container mx-auto max-w-6xl px-4 py-10 space-y-8">
        <header className="space-y-2">
          ...
          <p className="text-base" style={{ color: 'var(--secondary-label)' }}>
            We actively monitor {schemes.length} Indian government programmes for startups and
            MSMEs. Filter highlights below or use the dashboard&apos;s Eligibility Checker for a
                  ...
                  >
                    ...
                    <td className="px-4 py-4">
                      {scheme.official_link ? (
                        <a
                          href={
                            scheme.official_link.startsWith('http')
                              ? scheme.official_link
